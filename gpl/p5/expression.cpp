...
double Expression::eval_double()
{
	...
	else if(m_kind == VARIABLE)
	{
		...
		else if(o_type == ACOS)
		{
			...
			if(rightxp->get_type() == INT)
				return acos(rightxp->eval_int()*M_PI/180);
			else if (rightxp->get_type() == DOUBLE)
				return acos(rightxp->eval_double()*M_PI/180);
			else return 0.0;		
		}
		else if(o_type == ASIN)
		{
			...
			if(rightxp->get_type() == INT)
				return asin(rightxp->eval_int()*M_PI/180);
			else if (rightxp->get_type() == DOUBLE)
				return asin(rightxp->eval_double()*M_PI/180);
			else return 0.0;		
		}
		else if(o_type == ATAN)
		{
			...
			if(rightxp->get_type() == INT)
				return atan(rightxp->eval_int()*M_PI/180);
			else if (rightxp->get_type() == DOUBLE)
				return atan(rightxp->eval_double()*M_PI/180);
			else return 0.0;		
		}
		else if(o_type == SQRT)
		{
